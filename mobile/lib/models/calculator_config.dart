...
class CalculatorConfig {
  ...
  static CalculatorConfig get fallback => const CalculatorConfig(
        ...
        subjects: [],
        bonusFactors: [
          BonusFactor(factorType: 'grade_tier', factorKey: 'best', factorValue: 2.0),
          BonusFactor(factorType: 'grade_tier', factorKey: 'second', factorValue: 1.0),
          BonusFactor(factorType: 'grade_tier', factorKey: 'third', factorValue: 0.0),
          BonusFactor(factorType: 'grade_tier', factorKey: 'below', factorValue: -1.0),
