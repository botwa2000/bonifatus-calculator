...
export default async function AllowanceCalculatorPage({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-success-50 via-white to-primary-50 dark:from-neutral-900 dark:via-neutral-800 dark:to-neutral-900">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div className="mb-12">
          ...
          <p className="text-lg text-neutral-600 dark:text-neutral-300">{t('allowanceSubtitle')}</p>
        </div>
        ...
        <div className="mt-12 bg-gradient-to-r from-success-600 to-primary-600 rounded-2xl p-8 text-white text-center">
          <h2 className="text-xl font-bold mb-2">{t('allowanceCtaTitle')}</h2>
          <p className="opacity-90 mb-6">{t('allowanceCtaDesc')}</p>
          <Link
            href="/register"
            className="inline-block px-8 py-3 bg-white text-primary-600 rounded-lg font-semibold hover:shadow-xl transition-all"
          >
            {t('allowanceCtaButton')}
          </Link>
        </div>
      </main>
    </div>
