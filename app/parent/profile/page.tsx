...
const QRCode = dynamic(async () => (await import('qrcode.react')).default, { ssr: false })
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
      <header className="space-y-2">
        ...
        <h1 className="text-3xl font-bold text-neutral-900 dark:text-white">
          Linked children & invites
        </h1>
        <p className="text-neutral-600 dark:text-neutral-300">
          Generate a 6-digit code to link a child. They can enter the code or scan a QR. Remove
          connections anytime.
        </p>
      </header>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-5 shadow-sm space-y-4">
          ...
          {activeCode ? (
            ...
            <p className="text-sm text-neutral-500">Generate a code to start linking a child.</p>
          )}
        </div>
      </div>
    </div>
