...
-- Uses subquery category lookup so UUIDs stay portable across environments
...
VALUES (
  ...
  (SELECT id FROM subject_categories WHERE code = 'humanities'),
  false,
...
VALUES (
  ...
  (SELECT id FROM subject_categories WHERE code = 'sciences'),
  false,
  'physics_h1',
